...
<title> Smith & Ken Home Loans ~ Dubai Mortgages ~ Become Intro </title>
...
<h1>Become an Introducer Agent</h1>
<?php
$sql_home="select pagecontents from omort_pagecontents where page_id=11";
